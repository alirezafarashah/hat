...
class Trainer(object):
    ...
    def __init__(self, info, args):
        ...
        self.attack, self.eval_attack = self.init_attack(self.model, self.criterion, self.params.attack,
    ...
    def init_attack(model, criterion, attack_type, attack_eps, attack_iter, attack_step):
        ...
        """
        attack = create_attack(model, criterion, attack_type, attack_eps, attack_iter, attack_step,
    ...
    def train(self, dataloader, gen_dataloader=None, epoch=0, adversarial=False, verbose=True):
        """
