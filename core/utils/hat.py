...
#################
def new_hat_loss(model, x, y, x_gen, optimizer, y_gen=None, step_size=0.007, epsilon=0.031, perturb_steps=10, h=3.5,
                 beta=1.0, gamma=1.0,
    ...
    batch_metrics.update(
        {'adversarial_acc': accuracy(y, out_adv.detach()), 'helper_acc': accuracy(y_hr, out_help.detach())})
...
#################
def new_at_hat_loss(model, x, y, x_gen, optimizer, y_gen=None, step_size=0.007, epsilon=0.031, perturb_steps=10, h=3.5,
                    beta=1.0,
                    gamma=1.0,
                    attack='linf-pgd', hr_model=None):
    """
